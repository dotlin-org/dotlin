...
data class DartTryStatement(
    val body: DartBlock,
    val catchClauses: List<DartCatchClause> = emptyList(),
    val finallyBlock: DartBlock? = null
) : DartStatement {
    override fun <R, C> accept(visitor: DartAstNodeVisitor<R, C>, data: C): R =
        visitor.visitTryStatement(this, data)

    override fun <D> acceptChildren(visitor: DartAstNodeVisitor<Nothing?, D>, data: D) {
        body.accept(visitor, data)
        catchClauses.accept(visitor, data)
