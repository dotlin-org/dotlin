 ...
 *
 * Integers stored in the array are truncated to their low 64 bits,
...
external interface Int64Array : IArray<Int>, TypedData {
     ...
     *
     * The new array is an `Int64Array` containing the elements of this
     ...
     */
    override fun subArray(start: Int, end: Int?): Int64Array

    companion object {
        @Suppress("CONST_VAL_WITH_NON_CONST_INITIALIZER") // TODO: Fix in analyzer. Allow `dart()` for const
        const val bytesPerElement: Int = dart("Int64List.bytesPerElement")
    }
}