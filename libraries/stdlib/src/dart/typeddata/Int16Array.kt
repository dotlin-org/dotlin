...
/**
 * A fixed-size array of 16-bit signed integers that is viewable as a
 * [TypedData].
 *
 ...
 *
 * Integers stored in the array are truncated to their low 16 bits,
...
external interface Int16Array : IArray<Int>, TypedData {
     ...
     *
     * The new array is an `Int16Array` containing the elements of this
     ...
     */
    override fun subArray(start: Int, end: Int?): Int16Array

    companion object {
        @Suppress("CONST_VAL_WITH_NON_CONST_INITIALIZER") // TODO: Fix in analyzer. Allow `dart()` for const
        const val bytesPerElement: Int = dart("Int16List.bytesPerElement")
    }
}